...
from dianping.items import SportsItem


class SportsSpider(CrawlSpider):
    name = 'sports1'
    allowed_domains = ['www.dianping.com']
    start_urls = ['http://www.dianping.com/shenzhen/ch45']
    sportstype = ['g147', 'g151', 'g2838', 'g27852', 'g152', 'g156', 'g150', 'g6701', 'g146', 'g155', 'g154', 'g6702',
                  'g153', 'g6709', 'g6712', 'g6710', 'g6713', 'g6708', 'g6706', 'g145']
    custom_settings = {
        'LOG_FILE': 'log_sports1.txt',
    }
    def parse_start_url(self, response):
        for tp in self.sportstype:
            for loc in dz_location[::-1]:
                baseurl = 'http://www.dianping.com/shenzhen/ch45/%s%s' % (tp, loc)
