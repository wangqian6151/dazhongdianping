...
DOWNLOADER_MIDDLEWARES = {
    # 'dianping.middlewares.DianpinghotelDownloaderMiddleware': 543,
    # 'dianping.middlewares.ProxyMiddleware': 101,
    'dianping.middlewares.RandomUserAgentMiddleware': 443,
    'dianping.middlewares.RandomCookiesMiddleware': 545,
    'scrapy.downloadermiddlewares.retry.RetryMiddleware': None,
    'dianping.middlewares.TooManyRequestsRetryMiddleware': 540,
}
...
ITEM_PIPELINES = {
    ...
    'dianping.pipelines.MysqlPipeline': 301,
    # 'dianping.pipelines.DianpinghotelPipeline': 300,
}
